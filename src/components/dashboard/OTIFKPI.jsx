...
/**
 * OTIFKPI component for displaying On-Time In-Full metrics by region
 *
 * @param {Object} props
 * @param {string} props.title - Title of the KPI
 * @param {number} props.value - Overall OTIF percentage
 * @param {number} props.target - Target OTIF percentage
...
const OTIFKPI = ({
  ...
  target = 98,
  chartData = [
    { region: 'North', value: 85, color: '#FF3533' },
    { region: 'South', value: 82, color: '#FF3533' },
    { region: 'East', value: 80, color: '#FF3533' },
    { region: 'West', value: 95, color: '#4CAF50' },
    { region: 'Central', value: 98, color: '#4CAF50' }
  ],
  onDrillDown
}) => {
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Tooltip title="On-Time In-Full: Percentage of deliveries completed on time with full quantity">
            <span>
        ...
        {onDrillDown && (
          <Tooltip title="View details">
            <span>
              <IconButton
                size="small"
                onClick={() => onDrillDown({ id: 'otif', title })}
                sx={{ color: '#434F64' }}
              >
