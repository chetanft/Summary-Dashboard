        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>Trip Info</TableCell>
              <TableCell>Status</TableCell>
              <TableCell>Fulfillment SLA</TableCell>
              ...
              .map((journey) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      <Box>
                        <Typography variant="body2" color={journey.isDelayed ? 'error.main' : 'success.main'} sx={{ fontWeight: 500 }}>
